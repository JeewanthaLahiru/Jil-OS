;Jil --- The Jil Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE JilOs_VER '1.0.0'	 ;OS version number
	%DEFINE JilOs_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as JilOs and its programs
...
option_screen:
	...
	os_version_msg2		db 'Version ', JilOs_VER, 0

	dialog_string_1		db 'Welcome to JilOS Operating System', 0
	dialog_string_2		db 'Please select Info for HardwareInfo or', 0
...
os_draw_background1:
	...
	mov cx, 00001010b		; Colour: white text on light blue
